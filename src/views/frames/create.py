...
class Create(customtkinter.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.logo_label = customtkinter.CTkLabel(self, text="Crear Archivo", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.name_entry.grid(row=2, column=1, padx=20, pady=(10, 20), sticky="ew", columnspan=5)
        ...
        self.path_entry.grid(row=6, column=1, padx=20, pady=(10, 20), sticky="ew", columnspan=5)
